...
# STEP 2 [ALL sites]: download control.json to your working dir (/COVID_LOS_DLMM), 
# calculate AD, read the R output 
...
## OK DLMM is completed now, let's check the results
...
# first fit a linear regression model at each site
